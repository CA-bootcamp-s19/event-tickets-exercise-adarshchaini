...
contract EventTickets {
    ...
    */
    ...
    function buyTickets(uint tickets) payable public{

        require(myEvent.isOpen==true,'Event Not Open');
        require(myEvent.totalTickets>=tickets,'Insufficient Availability of Tickets');
        require(msg.value >= tickets*TICKET_PRICE,'Insufficient fund for the  tickets being purchased');
    ...
    */
    ...
    function getRefund() public{
        ...
        myEvent.totalTickets += purchasedTickets;
